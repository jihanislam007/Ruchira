...
public class YetToVisitFragment extends RuchiraFragment {
    private final static String TAG = "YetToVisitFragment";
    ...
    public YetToVisitFragment() {
    }

    public static YetToVisitFragment newInstance() {
        YetToVisitFragment yetToVisitFragment = new YetToVisitFragment();
        return yetToVisitFragment;
    }
