...
import com.techcoderz.ruchira.Fragments.AllOutletFragments.CustomerOrderDetailsFragment;
...
public class OrderSummaryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OrderSummaryAdapter.RecyclerViewSubHolders) {
            if (orderSummaryList.size() > 0) {
                ((OrderSummaryAdapter.RecyclerViewSubHolders) holder).date_txt.setText(orderSummaryList.get(position).getOrderDate());
                ...
                ((OrderSummaryAdapter.RecyclerViewSubHolders) holder).wholeContent.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        openCustomerOrderDetailsFragment(orderSummaryList.get(position).getOrderDate());
                    }
                });
            }
        }
    ...
    private void openCustomerOrderDetailsFragment(String orderDate) {
    ...
    class RecyclerViewSubHolders extends RecyclerView.ViewHolder {
        public TextView date_txt, quantity_txt, ammount_txt;
        public RelativeLayout wholeContent;
        public RecyclerViewSubHolders(View itemView) {
            super(itemView);
            date_txt = (TextView) itemView.findViewById(R.id.name_txt);
